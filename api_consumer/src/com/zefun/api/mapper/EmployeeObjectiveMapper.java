...
public interface EmployeeObjectiveMapper {
    ...
    * @return 是否成功
     ...
     * @return 赠送情况
     */
    List<Map<String, Object>> selectPresentDetail(Map<String, Object> map);
     ...
     * @return 是否成功
     */
    Integer insertNotPresentDetailList(List<Map<String, Object>> list);
    ...
    * @return 是否成功
     ...
     * @return 是否成功
     */
    Integer overdueGiftmoneyDetail(String endDate);
    ...
    * @return Integer
    ...
    /**
     * 查询业绩折扣比例(0-100)根据会员标识
    * @author 王大爷
    * @date 2015年12月26日 下午8:19:06
    * @param memberId 会员标识
    * @return Integer
     */
    Integer getPerformanceDiscountPercent(Integer memberId);
}