...
public class EmployeeShift {
	...
	/** 班次信息 */
	private ShiftInfo shiftInfoa;

	private ShiftInfo shiftInfob;
	...
	public ShiftInfo getShiftInfoa() {
		return shiftInfoa;
	}

	public void setShiftInfoa(ShiftInfo shiftInfoa) {
		this.shiftInfoa = shiftInfoa;
	}

	public ShiftInfo getShiftInfob() {
		return shiftInfob;
	}

	public void setShiftInfob(ShiftInfo shiftInfob) {
		this.shiftInfob = shiftInfob;
	}
