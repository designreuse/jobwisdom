...
jQuery(document).ready(function () {
	...
	jQuery('#toLeadModal').on('shown.bs.modal', function (e) {
			if(jQuery("#toLeadModal .modal-body").height()>200){
				
			
			jQuery("#toLeadModal .modal-body").css({"overflow":"auto"})
	
}
else{
	
	jQuery("#toLeadModal .modal-body").css({"overflow":"inherit"})
}
	})	
})
