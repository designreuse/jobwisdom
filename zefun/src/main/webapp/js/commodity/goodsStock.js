...
var isContent = false;
var goodsName ;
function findByGoodsName(obj){
	isContent = true;
	goodsName = jQuery("input[name='goodsStockName']").val();
	changePage();
}
...
function findByNames(){
	goodsNames = jQuery("input[name='goodsName']").val();
	isContent2 = true;
	changePageR();
}
//分页处理
function changePageR(){
	...
	if(goodsNames!="" && typeof(goodsNames)!="undefined")
		data = data + "&goodsName="+goodsNames;
	jQuery.ajax({
		type : "post",
