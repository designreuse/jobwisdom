...
(function () {
  ...
  var SwaggerModelProperty = function (name, obj, model) {
    ...
    console.log("---print absoluteType----");
    console.log(this.dataType.absoluteType);
   //this.isCollection = this.dataType && (this.dataType.absoluteType.toLowerCase() === 'array' || this.dataType.absoluteType.toLowerCase() === 'list' || this.dataType.absoluteType.toLowerCase() === 'set');
