		                    ...
		                    <c:forEach items="${slefItems}" var="slefItem">
			                    ...
			                    <input type="hidden" name="yulan" value="${slefItem.mediaId}">
		                            <div class="imgword-top">
		                                ...
		                                <c:choose>
									          <c:when test="${fn:length(slefItem.title) > 16}">
									              <a href="">${fn:substring(slefItem.title, 0, 16)}......</a>
									          </c:when>
									         <c:otherwise>
		                            ...
		                            <div class="imgword-opr">
		                               <ul>
						                    <li class="appmsg_opr_item grid_item size1of3">
						                        <a class="js_tooltip" href="<%=basePath%>wechat/send/update/item?mediaId=${slefItem.mediaId}" data-tooltip="编辑">&nbsp;
						                            <i title="编辑" id="61" class="iconfont icon-dizhixiugai"></i>
						                        </a>
						                    </li>
						                    <li class="appmsg_opr_item grid_item size1of3 no_extra delete" onclick="deleteItems('mAgiqgI8pIrcRSo4HygPq4z98OlF_J9FQF_2i5T5k58',this)">
						                        <a class="js_del no_extra js_tooltip" data-id="208999880" href="<%=basePath%>wechat/send/items?mediaId=${slefItem.mediaId}" data-tooltip="发送图文">
						                            &nbsp;<i title="发送图文" class="iconfont icon-svg35"> </i>
						                        </a>
						                    </li>
						                    <li class="appmsg_opr_item grid_item size1of3 no_extra delete" onclick="deleteItems('${slefItem.mediaId}',this)">
						                        <a class="js_del no_extra js_tooltip" data-id="208999880" href="javascript:void(0);" data-tooltip="删除">
		                            ...
		                            <div class="imgword-top">
		                                ...
		                                <c:choose>
									          <c:when test="${fn:length(items.title) > 16}">
									              <a href="">${fn:substring(items.title, 0, 16)}......</a>
									          </c:when>
									         <c:otherwise>
