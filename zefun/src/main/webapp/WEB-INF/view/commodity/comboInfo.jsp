		    ...
		    <div class="contentinner">
		        <div class="project-list">
		            <div class="project-list-head">
		                <input type="search" placeholder="搜索" class="search-input" onkeyup="searchComboInfo(this)" onfocus='if(jQuery(".fuzzysearch").children("li").length>0){jQuery(".fuzzysearch").show();}'/>
			                ...
			                <table class="table ">
			                    ...
			                    <tbody>
				                    <tr>
				                        ...
				                        <td>
				                        <input type="checkbox" class="isCountLimit" id="isCountLimit" value="1" checked="checked" autocomplete="on">
				                        </td>
				                        <td>
				                        ...
				                        <input type="hidden" name="isCountLimit" value="1">
				                        </td>
				                    </tr>
			                    </tbody>
			                </table>
		                ...
		                <div class="widgetcontent">
		                    ...
		                    <tbody>
			                    <tr>
			                        ...
			                        <td><input type="text" class="input70" name="comboPerformance" id="comboPerformance" datatype="n" nullmsg="请输入员工销售业绩计算！" errormsg="员工销售业绩计算:请输入大于1以上的数字！"/><span class="percent-symbol">%</span></td>
			                    </tr>
		                    </tbody>
		                </table>
		                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content jietu ">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">上传套餐图片</h4>
            </div>
...
<tr>
									...
									<td>
				                        <input type="text" class="input70 Validform_error" name="comboGoodsPerformanceCal" datatype="d2-2" errormsg="单次服务业绩计算：请输入数字" nullmsg="请填写单次服务业绩计算！"><span class="percent-symbol">元</span>
				                    </td>
			                        <td><i class="cursor iconfa-minus" onclick="deleteGoodsList(this);"></i></td>
			                    </tr>
</script>
