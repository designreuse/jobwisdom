		    ...
		    <div class="contentinner">
				...
				<div class="project-list">
		            <div class="project-list-head">
		                <input type="search" placeholder="搜索" class="search-input" onkeyup="searchProject(this)" onfocus='if(jQuery(".fuzzysearch").children("li").length>0){jQuery(".fuzzysearch").show();}'/>
		            ...
		            <form id="projectform">
		                ...
		                <div class="img-word">
		                    ...
		                    <div class="x-edit-right" style="margin-bottom: 10px;">
		                        ...
		                        <div class="two-part">
			                    	<label for="" class="font-bold">项目类型</label>
			                        <select data-placeholder="选择项目类型"  class="chzn-select input80" name="projectType">
			                       	 	<option value="0">选择项目类型</option>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content jietu ">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">上传项目图片</h4>
            </div>
...
<script>
	/* var replaceStr = "\r\n";
	var deptProjectList = eval("(" + '${js_deptProjectList}'.replace(new RegExp(replaceStr,'gm'),'') + ")");
	var deptMahjongList = eval("(" + '${mahjongList}'.replace(new RegExp(replaceStr,'gm'),'') + ")");
	var memberLevelList = eval("(" + '${memberLevelList}'.replace(new RegExp(replaceStr,'gm'),'') + ")"); */
