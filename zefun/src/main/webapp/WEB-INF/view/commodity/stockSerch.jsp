...
<script>
	...
	// 初始化时间
	jQuery("input[name='postageSerchStartDate']").val(new Date().pattern("yyyy-MM-dd"));
	jQuery("input[name='postageSerchStopDate']").val(new Date().pattern("yyyy-MM-dd"));
	jQuery("input[name='detailStartDate']").val(new Date().pattern("yyyy-MM-dd"));
	jQuery("input[name='detailStopDate']").val(new Date().pattern("yyyy-MM-dd"));
	jQuery("input[name='flowStartDate']").val(new Date().pattern("yyyy-MM-dd"));
	jQuery("input[name='flowStopDate']").val(new Date().pattern("yyyy-MM-dd"));
	serchGoodFlow();
	serchDetailStore();
	serchPostage();
