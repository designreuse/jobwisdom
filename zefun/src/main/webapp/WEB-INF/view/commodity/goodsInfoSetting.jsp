				...
				<div class="tab_content">
					...
					<div class="tab_content_div clearfix">
						<div class="tab_content_div_left">
							...
							<div>
								设置商品类别： <select name="categoryId" style="box-shadow: 0 0 3px #ccc;">
					...
					<div class="tab_content_div clearfix">
						...
						<div class="tab_content_div_left">
							...
							<div>
								员工业绩方式:<select name="calculationType" style="box-shadow: 0 0 3px #ccc;position: relative; left: 44px!important;">
