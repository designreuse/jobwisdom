		    ...
		    <div class="contentinner">
		        <div class="project-list">
		            <div class="project-list-head">
		                <input type="search" placeholder="搜索" class="search-input" onkeyup="searchGodsInfo(this)"  onfocus='if(jQuery(".fuzzysearch").children("li").length>0){jQuery(".fuzzysearch").show();}'/>
		                  ...
		                  <table class="table">
		                      ...
		                      <tbody>
			                      <tr>
			                          ...
			                          <td><input type="text" class="input70" name="costPrice" id="costPrice" datatype="d2-2" errormsg="成本价格:请输入整数,可以保留两位小数" nullmsg="请填写成本价格!"/><span class="percent-symbol">元</span></td>
			                          <td><input type="checkbox" name="calculationType" id="calculationType" value="1" class="calculationType" checked="checked" autocomplete="on" /></td>
                        ...
                        <div class="more-toolbar" >
                            <div class="table-toolbar">
			                    ...
			                    <input type="text" id="memberLastAccount" class="input30" onkeyup="setMemberLastAccount(this)"><span class="percent-symbol">%</span>
			                    	设置固定价格
			                    <img src="http://7xkv8r.com1.z0.glb.clouddn.com/help.png" alt="" class="ml5" data-toggle="tooltip" data-placement="top" title="" data-original-title="有些会员卡比该商品的最低折扣还低,再次输入一个最低折扣,将会对所有小于该折扣的会员进行设置">
			                    </label>
                            </div>
                            <div class="clearfix"></div>
                        </div>  
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content jietu ">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">上传商品图片</h4>
            </div>
...
<script>
	...
	var deptGoodsList = ${js_deptGoodsBaseDto};
