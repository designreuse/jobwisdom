...
<%--     <div class="px-search">
        ...
        <input type="text" placeholder="搜素关键字" value="${keyword }">
        <span class="iconfont icon-sousuo"></span>
        </form>
    </div> --%>
    <div class="store-number">
         <span class="fl c-999">智放门店总数：<span class="c-333">${totalStore }</span></span>
         <span class="fr c-999">关注会员总数：<span class="c-333">${totalWechat }</span></span>
    </div>
