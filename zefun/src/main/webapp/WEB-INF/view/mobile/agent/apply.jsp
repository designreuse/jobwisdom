...
<body>
<div class="head">
    <img src="<%=basePath%>images/mobile/agent/logo-head.png" alt="" class="head-img"/>
</div>
<img src="<%=basePath%>images/mobile/agent/shenqing.png" alt="" class="animation-person"/>
