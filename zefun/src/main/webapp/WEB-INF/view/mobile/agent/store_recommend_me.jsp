                ...
                <li class="shop-detail <c:if test="${!storeInfoStatus.first }">hide</c:if>">
                    <ul class="shop-detail-ul">
                        ...
                        <li class="recommend-people normal-li">
                            <span class="key">推荐渠道商</span>
                            <c:set var="agent" value="无"/>
                            <c:if test="${not empty loaclAgentInfos[storeInfo.storeId] }">
                            <c:set var="agent" value="${loaclAgentInfos[storeInfo.storeId].province }${loaclAgentInfos[storeInfo.storeId].city }"/>
                            </c:if>
