            ...
            <ul class="new-shop-item">
                ...
                <li class="shop-detail">
                    <ul class="shop-detail-ul none-hide">
                        ...
                        <li class="normal-li">
                            <span class="key">登陆账号</span>
                            <span class="value fr">${pc_user_name }</span>
                        </li>
                        <li class="normal-li">
                            <span class="key">默认密码</span>
                            <span class="value fr">123456</span>
                        </li>
                        <li class="normal-li">
                            <span class="key">开通时间</span>
                        ...
                        <li class="normal-li">
                            <span class="key">系统剩余</span>
                            <span class="value fr"><span class="red">${storeAccount.balanceDays }</span>天</span>
                        </li>
                        <li class="normal-li">
                            <span class="key">短信剩余</span>
                            <span class="value fr"><span class="red">${storeAccount.balanceSms }</span>条</span>
                        </li>
                        </c:if>
                    </ul>
                </li>
