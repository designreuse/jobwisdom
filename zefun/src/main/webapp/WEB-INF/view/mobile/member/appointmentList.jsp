    ...
    function cancel(appointmentId, employeeId, projectId){
    	...
    	$.ajax({
    		...
    		success : function(e){
    			...
    			at.find("[name='operate']").html('<div class="qiandan active"><a href="' + baseUrl + 'memberCenter/view/projectDetail?storeId=${session_key_store_id}&projectId=' + projectId + '">再次预约</a></div>');
    		}
    	});
    }
