	          ...
	          <li class="designer-item-content">
	              ...
	              <div class="info">
	                  <div class="info-wrap">
	                      ...
	                      <span class="ml normoal-word font-size-28 font-666">(${employeeInfo.levelName })</span></div>
	              ...
	              <a href="javascript:appoint('${employeeInfo.employeeId }','${employeeInfo.name }','${employeeInfo.levelName }')" class="order-btn fr">预约</a>
	          </li>
	      </ul>
	    </div>
...
var projectStepOrder = "${projectStep.projectStepOrder}";
var shiftMahjongId = "${projectStep.shiftMahjongId}";
