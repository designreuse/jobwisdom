    ...
    <div class="contentinner">
            ...
            <table class="table collect-money-table">
                ...
                <tr>
                    ...
                    <select data-placeholder="选择类型"  id="choiceType" class="chzn-select-search input80" onchange="showtype()">
                        ...
                        <select data-placeholder="选择大小"  id="contrastType" class="chzn-select-search" style="width:86px">
        ...
        <div id="custom-toolbar" class="more-toolbar">
            <div class="table-toolbar">
                ...
                <button class="button-search btn" style="margin-left: -10px;" onclick="searchEmployeeObjective()">查询</button>
        ...
        <table class="table table-bordered table-striped collect-money-table1">
            ...
            <tbody>
            <c:forEach items="${page.results}" var="list" varStatus="index">
            <c:if test="${index.index == 0 }">
            	<tr id="${list.ruleId}" class="t-table">
            </c:if>
            <c:if test="${index.index != 0 }">
            	<tr id="${list.ruleId}">
            </c:if>
