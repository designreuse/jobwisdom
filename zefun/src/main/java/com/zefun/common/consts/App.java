...
//        public static final String WECHAT_OPENID_TO_SUBSCRIBE_GIFT_KEY_HASH = "wechat_openid_to_subscribe_gift_key_hash";
    ...
    class Wechat {
        ...
        public static final String AUTH_REDIRECT_BASE_URL = "https://open.weixin.qq.com/connect/oauth2/authorize?"
                + "appid={app_id}&redirect_uri=http%3A%2F%2F" + App.System.SERVER_HOST + "%2Fjobwisdom%2Fwechat%2Fcallback%2F{openid_key}"
    ...
    * @date Jan 28, 2016 6:06:39 PM
    ...
    class Ubox {
        /** 友宝测试应用ID */
//        public static final String APP_ID = "5586bd041f7dd84ac8018a4f6c96edac";
//        /** 友宝测试应用密钥 */
//        public static final String APP_SECRET = "3a6ee102c4a1061f9d1c632fbefb9182";
        /** 友宝正式应用ID */
        ...
        /** 友宝测试API路径 */
//        public static final String API_REQUEST_URL = "http://monk.dev.uboxol.com/";
        /** 友宝正式API路径 */
