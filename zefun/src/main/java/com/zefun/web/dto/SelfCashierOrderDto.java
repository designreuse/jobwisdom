...
public class SelfCashierOrderDto implements Serializable {
    ...
    /** 会员子账户列表 */
    private List<MemberSubAccountDto> subAccountList;
    ...
    public List<MemberSubAccountDto> getSubAccountList() {
        return subAccountList;
    }

    public void setSubAccountList(List<MemberSubAccountDto> subAccountList) {
