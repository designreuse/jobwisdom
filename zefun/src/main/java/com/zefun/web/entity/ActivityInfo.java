...
public class ActivityInfo {
    ...
    /** 岗位标识 */
    private Integer activityPositionOne;

    /** 岗位标识 */
    private Integer activityPositionTwo;

    /** 岗位标识 */
    private Integer activityPositionThree;
    ...
    public Integer getActivityPositionOne() {
        return activityPositionOne;
    }

    public void setActivityPositionOne(Integer activityPositionOne) {
        this.activityPositionOne = activityPositionOne;
    }

    public Integer getActivityPositionTwo() {
        return activityPositionTwo;
    }

    public void setActivityPositionTwo(Integer activityPositionTwo) {
        this.activityPositionTwo = activityPositionTwo;
    }

    public Integer getActivityPositionThree() {
        return activityPositionThree;
    }

    public void setActivityPositionThree(Integer activityPositionThree) {
