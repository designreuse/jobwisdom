...
public class CouponController extends BaseController{
    ...
    * @return 跳转页面
    ...
    @ResponseBody
    public BaseDto actionDeleteCoupons(HttpServletRequest request, Integer couponId) throws ParseException{
        Integer storeId = getStoreId(request);
        return couponService.actionDeleteCoupons(couponId, storeId);
    }
