...
public interface EmployeeObjectiveMapper {
    ...
    * @return BigDecimal
     ...
     * @param objectiveMonth  目标年月份
     * @return  员工目标
     */
    EmployeeObjective selectObjectByEmployeeIdAndDate(@Param(value="employeeId")int employeeId, @Param(value="objectiveMonth")String objectiveMonth);
}