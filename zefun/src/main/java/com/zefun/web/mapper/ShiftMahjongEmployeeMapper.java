...
public interface ShiftMahjongEmployeeMapper {
    ...
    * @return 是否成功
     ...
     * 将当前员工排位前的员工 +1 
    * @author 王大爷
    * @date 2015年12月22日 下午3:17:28
    * @param record 轮牌员工信息
    * @return 是否成功
     */
    int updateAddBig(ShiftMahjongEmployee record);
    ...
    * @return 轮牌员工
     */
    ShiftMahjongEmployee selectShiftMahjongLastEmployee(Integer detailId);
    ...
    * @return EmployeeInfo
     */
    ShiftMahjongEmployee selectEmployeeByStepId(Map<String, Integer> map);
}