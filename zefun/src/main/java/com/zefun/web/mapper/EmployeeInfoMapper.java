...
public interface EmployeeInfoMapper {
    ...
    * @return List
     ...
     * 根据门店查询员工
    * @author DavidLiang
    * @date 2016年3月2日 下午3:12:29
    * @param storeId  店铺id
    * @return  员工集
     */
    List<EmployeeInfo> selectEmployeeByStoreId(@Param(value="storeId")int storeId);
    ...
    * @return List<EmployeeInfo>
     ...
     * 根据门店标识查询员工标识列表
    * @author 张进军
    * @date Dec 25, 2015 10:13:47 PM
    * @param storeId	门店标识
    * @return	员工标识列表
     */
    List<Integer> selectEmployeeIdByStoreId(int storeId);
	...
	List<EmployeeDto> selectAllEmployeeByCondition(Map params);
    
    /**
     * 根据部门查询员工(未删除)
    * @author DavidLiang
    * @date 2016年2月18日 下午2:26:05
    * @param deptId  部门id
    * @return  员工集
     */
    List<EmployeeInfo> selectEmployeeByDept(@Param(value="deptId")int deptId);
    
    /**
     * 根据店铺部门岗位职位组合查询员工
    * @author DavidLiang
    * @date 2016年3月3日 下午4:58:08
    * @param storeId  店铺id
    * @param deptId  部门id
    ...
    * @return  员工集
     */
    List<EmployeeInfo> selectEmployeeByStoreOrDeptOrPositionOrLevel(@Param(value="storeId")Integer storeId, 
    		  @Param(value="deptId")Integer deptId, @Param(value="positionId")Integer positionId, @Param(value="levelId")Integer levelId);
}