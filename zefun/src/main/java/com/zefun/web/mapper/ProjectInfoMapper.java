...
public interface ProjectInfoMapper {
     ...
     * 查询某个职位下所有可预约项目
    * @author 张进军
    * @date Jan 29, 2016 3:19:00 PM
    * @param employeeLevelId    员工职位标识
    * @return   可预约项目列表
     */
    List<ProjectBaseDto> selectAppointProjectByEmployeeLevelId(int employeeLevelId);
    ...
    * @return ProjectMahjongProjectStepDto
     ...
     * 部门标识
    * @author 王大爷
    * @date 2015年12月30日 下午7:52:49
    * @param detailId 明细标识
    * @return 部门标识
     */
    Integer selectByDetailId(Integer detailId);
    
    /**
     * 查询某个职位下所有可预约项目(基于对象)
    * @author DavidLiang
    * @date 2016年2月19日 下午7:48:02
    * @param employeeLevelId  员工职位id
    * @return  可预约项目集
     */
    List<ProjectInfo> selectCanAppointmentProjectByEmployeeLevelId(@Param(value="employeeLevelId")int employeeLevelId);
    
    /**
     * 根据项目系列id和职位id查询项目
    * @author DavidLiang
    * @date 2016年2月19日 下午8:30:57
    * @param categoryId  项目系列id
    * @param levelId  职位id
    * @return  项目集
     */
    List<ProjectInfo> selectProjectByCategoryIdAndLevelId(@Param(value="categoryId")int categoryId, @Param(value="levelId")int levelId);
}