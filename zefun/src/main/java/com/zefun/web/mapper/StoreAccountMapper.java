...
public interface StoreAccountMapper {
    ...
    * @author 张进军
    * @date Feb 23, 2016 9:47:17 AM
    * @param storeAccount   门店账户标识、系统使用天数、短信数量
    * @return   0:失败，1:成功
     */
    int updateSysAndSmsByStoreId(StoreAccount storeAccount);
     ...
     * @return 排序后的门店账户
     */
    List<StoreAccount> selectOrderedAccountByStoreIds(List<Integer> storeIds);
